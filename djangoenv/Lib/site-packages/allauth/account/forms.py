...
class LoginForm(forms.Form):
    ...
    password.widget.attrs['class'] = 'form-control form-control-lg'
    ...
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            ...
            login_widget = forms.TextInput(
                attrs={"placeholder": _("Username"), "autocomplete": "username","class":"form-control form-control-lg",}
            )
            ...
            login_widget = forms.TextInput(
                attrs={"placeholder": _("Username or e-mail"), "autocomplete": "email","class":"form-control form-control-lg",}
            )
            login_field = forms.CharField(
...
class BaseSignupForm(_base_signup_form_class()):
    username = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"id":"form3Example3" ,"class":"form-control form-control-lg", "placeholder": _("Username"), "autocomplete": "username"}
        ),
    )
